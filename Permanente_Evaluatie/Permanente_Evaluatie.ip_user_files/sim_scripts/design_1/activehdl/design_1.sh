...
#
# Script generated by Vivado on Wed Jan 10 23:21:05 +0100 2024
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/devWorks/Permanente_Evaluatie/Permanente_Evaluatie.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
